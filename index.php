                    ...
                    <div class="block">
                        ...
                        <div class="block__content">
                            <div class="articles articles__horizontal">
                                ...
                                <?php
                                $articles = mysqli_query($dbc, "SELECT * FROM `articles` ORDER BY `id` DESC LIMIT 10");

                                while ($art = mysqli_fetch_assoc($articles)) {
                                    ?>
                                    <article class="article">
                                        <div class="article__image"
                                             style="background-image: url(media/images/<?= $art['image']; ?>);"></div>
                    ...
                    <div class="block">
                        ...
                        <div class="block__content">
                            <div class="articles articles__horizontal">
                                ...
                                <?php
                                $articles = mysqli_query($dbc, "SELECT * FROM `articles` WHERE `categories_id` = 7 ORDER BY `id` DESC LIMIT 10");
                                    ...
                                    <article class="article">
                                        ...
                                        <div class="article__info">
                                            ...
                                            <div class="article__info__meta">
                                                ...
                                                ?>
                                                <small>Категория: <a href="/articles.php?categories=<?= $art_cat['id']; ?>"><?= $art_cat['title']; ?></a></small>
                                            </div>
                                            <div class="article__info__preview"><?= mb_substr(strip_tags($art['text']), 0, 100, 'utf-8') . ' ...'; ?></div>
                                        </div>
                                    </article>
                    ...
                    <div class="block">
                        ...
                        <div class="block__content">
                            <div class="articles articles__horizontal">
                                ...
                                <?php
                                $articles = mysqli_query($dbc, "SELECT * FROM `articles` WHERE `categories_id` = 3 ORDER BY `id` DESC LIMIT 10");
                            ...
                            <div class="articles articles__vertical">
                                ...
                                <article class="article">
                                    ...
                                    <div class="article__info">
                                        ...
                                        <div class="article__info__preview">Бла бла бла бла бла бла бла, и думаю еще что
